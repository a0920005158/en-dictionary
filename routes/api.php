...
Route::match(['get', 'post'], '/store-plan', [PlanHandleController::class, 'store']);
Route::match(['get', 'post'], '/modify-plan', [PlanHandleController::class, 'modify']);
Route::match(['get', 'post'], '/comment-plan', [PlanHandleController::class, 'comment']);
Route::match(['get', 'post'], '/get-comment-plan', [PlanHandleController::class, 'getComment']);
Route::match(['get', 'post'], '/get-all-comment-plan', [PlanHandleController::class, 'getAllComment']);
